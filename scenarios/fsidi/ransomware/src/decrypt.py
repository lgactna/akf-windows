...
def decrypt_files(salt_hex: str, iv_hex: str, use_machine_guid: bool = True, key_hex: str = None) -> int:
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Decrypt files encrypted by ransomware")
    parser.add_argument("--salt", required=True, help="Hex string of the salt used for encryption")
    parser.add_argument("--iv", required=True, help="Hex string of the IV used for encryption")
    parser.add_argument("--key", help="Hex string of the key (if not using machine GUID)")
