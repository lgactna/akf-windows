...
logger.info(r'Executing action: Create a new CASE bundle to be reused throughout the scenario')
...
with WindowsArtifactServiceAPI.auto_connect(vbox_obj.get_maintenance_ip()) as win_artifact:
...
akf_bundle.write_to_jsonld(
    Path("C:/Users/kisun/Desktop/bundle.jsonld"),
    indent=2
)
